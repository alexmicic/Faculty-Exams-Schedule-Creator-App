...
namespace DiplomskiDezurstvo
{
        ...
        : DropCreateDatabaseAlways<ApplicationDbContext>
    {
        ...
        public static void InitializeIdentityForEF(ApplicationDbContext db)
        {
            ...
            // Initial Admin user:
            const string name = "alexander.micic@gmail.com";
            const string password = "dipL0mski!";
            ...
            const string roleDescription = "All access";
            ...
            const string usersRoleDescription = "Plain User";
