...
// main app module
var mainModule = angular.module('main', ['ngRoute', 'angular-loading-bar', 'loginCheck']);

// glavni controller
mainModule.controller("indexViewModel", function ($scope, $http, $q, $routeParams, $window, $location, $logincheck) {
